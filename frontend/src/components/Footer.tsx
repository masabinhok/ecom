...
const Footer = () => {
  return (
    <main className="w-full bg-black-800 text-white-100 flex flex-col items-center justify-center gap-5 p-5 z-50 ">
      <section className=" grid justify-items-center grid-cols-[repeat(auto-fit,minmax(200px,1fr))] w-full max-w-[1320px] text-sm mt-10 ">
